package ru.zotov.carracing.profile.config;

/**
 * @author Created by ZotovES on 21.02.2022
 */
...
public class SpringfoxConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .apiInfo(apiInfo())
                .tags(new Tag(PROFILE, "Управление профилем игрока"));
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("CarRacing")
                .description("Микросервис управления профиля игрока ")
                .version("1.0")
                .build();
    }
}
