...
public class SpringfoxConfig {
    ...
    public static final String RACE_TEMPLATE = "Race template";
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .apiInfo(apiInfo())
                .tags(new Tag(RACE, "Управление заездами"), new Tag(RACE_TEMPLATE, "Управление шаблонами заездов"));
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("CarRacing")
                .description("Микросервис заездов ")
                .version("1.0")
                .build();
    }
}
