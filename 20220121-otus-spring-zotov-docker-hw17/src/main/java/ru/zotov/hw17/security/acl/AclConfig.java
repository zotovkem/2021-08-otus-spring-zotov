package ru.zotov.hw17.security.acl;
...
import ru.zotov.hw17.security.SecurityConfig;
...
public class AclConfig {
    ...
    public AclAuthorizationStrategy aclAuthorizationStrategy() {
        return new AclAuthorizationStrategyImpl(new SimpleGrantedAuthority(SecurityConfig.ROLE_ADMIN));
    }
